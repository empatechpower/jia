...
export const LAMINATE_COLORS: LaminateColor[] = [
  ...
  { id: "charcoal-linen", name: "CHARCOAL LINEN",  code: "4003", hex: "#3A3A3A" },
  ...
  { id: "matt-dust-storm", name: "MATT DUST STORM", code: "JM-0005", hex: "#C4C1B0" },
  { id: "gloss-dust-storm", name: "GLOSS DUST STORM", code: "JM-0005A", hex: "#B9B6A0" },
];
...
export const DOOR_OPTIONS_DEFAULT = [
  "Timber Door",
  "No Door",
];
...
export const HANDLE_DESIGNS: HandleDesign[] = [
  {
    id: "Handle 1",
    name: "Handle 1",
    imageUrl: "https://images.unsplash.com/photo-1738520420690-9680253bf40b?w=400&q=80",
    colorOptions: ["Red", "Blue", "Black"],
  },
  {
    id: "Handle 2",
    name: "Handle 2",
    imageUrl: "https://images.unsplash.com/photo-1755870190789-113202c5096c?w=400&q=80",
    colorOptions: ["Red", "Blue", "Black"],
  },
  {
    id: "Handle 3",
    name: "Handle 3",
    imageUrl: "https://images.unsplash.com/photo-1566550023687-585a9c11eed0?w=400&q=80",
...
export const ALUMINIUM_FINISHINGS: AlumFinishing[] = [
  { id: "Mirror Clear",  name: "Mirror Clear",  imageUrl: "https://images.unsplash.com/photo-1758985142652-2e9c88d88bb4?w=400&q=80" },
  { id: "Mirror Black",  name: "Mirror Black",  imageUrl: "https://images.unsplash.com/photo-1682024608823-f604953a3cdb?w=400&q=80" },
  { id: "Mirror Bronze", name: "Mirror Bronze", imageUrl: "https://images.unsplash.com/photo-1676807882679-7cb547cc6c54?w=400&q=80" },
  { id: "Glass Clear",   name: "Glass Clear",   imageUrl: "https://images.unsplash.com/photo-1737256359088-9b915e3efc66?w=400&q=80" },
  { id: "Glass Black",   name: "Glass Black",   imageUrl: "https://images.unsplash.com/photo-1669049765987-c61ad9e364e8?w=400&q=80" },
  { id: "Glass Bronze",  name: "Glass Bronze",  imageUrl: "https://images.unsplash.com/photo-1557852101-b6af39607675?w=400&q=80" },
];
...
export interface ProductConfig {
  ...
  remarks:                  string;
  casementDoorOpening:      string | null;
  casementAluminumFrame:    string | null;
  casementFinishing:        string | null;
  doorTypeOptional:         string | null;
  slidingFinishing:         string | null;
  kitchenCasementDoorOpening: string | null;
  blumRunnerUpgrade:        string | null;
}

export const EMPTY_CONFIG: ProductConfig = {
  internalColor: null, externalColor: null, width: null,
  doorOption: null, sidePanel: null, addLock: null, numberOfLocks: null,
  ledStrip: null, handleDesign: null, handleColor: null,
  aluminiumFrameColor: null, aluminiumDoorFinishing: null, remarks: "",
  casementDoorOpening: null, casementAluminumFrame: null, casementFinishing: null,
  doorTypeOptional: null, slidingFinishing: null,
  kitchenCasementDoorOpening: null, blumRunnerUpgrade: null,
};
